...
async function main() {
    ...
    const techAdmin = await prisma.user.upsert({
        ...
        create: {
            ...
            password: hashedPassword,
            name: '이기술',
            role: client_1.UserRole.TECH_ADMIN,
    ...
    const contents = [
        {
            ...
            platform: client_1.Platform.TISTORY,
            topic: 'AI & 머신러닝',
            seoScore: 92,
            views: 15420,
            clicks: 892,
        ...
        },
        {
            ...
            status: client_1.ContentStatus.PUBLISHED,
            platform: client_1.Platform.BOTH,
            topic: '웹개발',
            seoScore: 88,
            views: 8930,
            clicks: 567,
        ...
        },
        {
            ...
            status: client_1.ContentStatus.SCHEDULED,
            platform: client_1.Platform.TISTORY,
            topic: '클라우드 & DevOps',
            seoScore: 85,
            views: 0,
        ...
        },
        {
            ...
            status: client_1.ContentStatus.REVIEW,
            platform: client_1.Platform.WORDPRESS,
            topic: '모바일 개발',
            seoScore: 78,
            views: 0,
            clicks: 0,
    ...
    for (const contentData of contents) {
        ...
        const content = await prisma.content.upsert({
            where: { id: contentData.title.length },
            update: {},
            create: {
    ...
    const scheduledContents = await prisma.content.findMany({
        where: { status: client_1.ContentStatus.SCHEDULED },
    });
    ...
    const notifications = [
        {
            userId: admin.id,
            type: client_1.NotificationType.PUBLISH_SUCCESS,
            title: '발행 완료',
        ...
        {
            userId: admin.id,
            type: client_1.NotificationType.API_ERROR,
            title: 'API 오류 발생',
        ...
        {
            userId: editor.id,
            type: client_1.NotificationType.SEO_WARNING,
            title: 'SEO 점수 낮음',
        ...
        {
            userId: editor.id,
            type: client_1.NotificationType.SCHEDULE_REMINDER,
            title: '예약 발행 알림',
        ...
        {
            userId: marketer.id,
            type: client_1.NotificationType.KEYWORD_ALERT,
            title: '키워드 트렌드 상승',
        ...
        {
            userId: admin.id,
            type: client_1.NotificationType.DUPLICATE_DETECTED,
            title: '중복 콘텐츠 감지',
    ...
    const reports = [
        {
            type: client_1.ReportType.WEEKLY,
            format: client_1.ReportFormat.PDF,
            title: '주간 블로그 성과 리포트 - 2024년 11월 4주차',
            dateFrom: new Date('2024-11-18'),
            dateTo: new Date('2024-11-24'),
        },
        {
            type: client_1.ReportType.MONTHLY,
            format: client_1.ReportFormat.CSV,
            title: '월간 블로그 성과 리포트 - 2024년 11월',
            dateFrom: new Date('2024-11-01'),
            dateTo: new Date('2024-11-30'),
        },
        {
            type: client_1.ReportType.CUSTOM,
            format: client_1.ReportFormat.JSON,
